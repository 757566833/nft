/**
 * 复制粘贴的https://github.com/dankogai/js-base64/blob/main/base64.ts
 */
const version = '3.6.1';
/**
...
const _fromCC:any = String.fromCharCode.bind(String);
const _U8Afrom:any = typeof Uint8Array.from === 'function' ?
    Uint8Array.from.bind(Uint8Array) :
    (it:any, fn: (any:any) => number = (x) => x) =>
...
const _toUint8Array = _hasBuffer ?
    ...
    (a: string) => _U8Afrom(_atob(a), (c:any) => c.charCodeAt(0));
/**
 ...
 * @returns {string} UTF-8 string
 */
const decode:any = (src: string) => _decode(_unURI(src));
/**
...
const extendString = function() {
  ...
  const _add = (name:any, body:any) => Object.defineProperty(
  ...
  _add('toBase64', function(urlsafe:any) {
    // @ts-ignore
